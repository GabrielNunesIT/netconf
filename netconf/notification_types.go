...
//
//	var cc NetconfConfigChange
//	wrapped := append([]byte("<w>"), append(n.Body, []byte("</w>")...)...)
//	var wrapper struct {
//	    CC NetconfConfigChange `xml:"netconf-config-change"`
//	}
...
// EditRecord describes a single edit operation within a netconf-config-change
...
// NetconfConfigChange is the RFC 6470 netconf-config-change notification body.
...
// NetconfCapabilityChange is the RFC 6470 netconf-capability-change notification
...
type NetconfCapabilityChange struct {
...
// NetconfSessionStart is the RFC 6470 netconf-session-start notification body.
...
// NetconfSessionEnd is the RFC 6470 netconf-session-end notification body.
...
// NetconfConfirmedCommit is the RFC 6470 netconf-confirmed-commit notification
...
type NetconfConfirmedCommit struct {
